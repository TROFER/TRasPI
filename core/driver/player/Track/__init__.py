...
class Track:
    ...
    def __new__(cls, arg, *args, raw=False, **kwargs):
        ...
        elif isinstance(arg, (http.client.HTTPResponse, sys.Request, socket.socket)):
    ...
    @overload
    def __init__(self, socket: Union[http.client.HTTPResponse, sys.Request, socket.socket]): ...
