...
class Item:
    ...
    def __init__(self, name: str, image: str):
        self.icon = core.element.Image(core.Vector(1, 20), core.asset.Image(image))
        self.label = core.element.Text(core.Vector(12, 20), name)

    def select(self):
        pass

    def render(self, index):
        self.icon.pos = core.Vector(1, 20 + 10 * index)
        self.icon.render()
